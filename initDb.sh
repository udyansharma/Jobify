...
create table job(job_id int UNIQUE, description TEXT NOT NULL,number_of_applicants int NULL,city VARCHAR(60),posted_by int,status VARCHAR(1), profile VARCHAR(70) , experience FLOAT(3,2) DEFAULT 0);
create table applications(job_id int AUTO_INCREMENT PRIMARY KEY, applicant_id int);
